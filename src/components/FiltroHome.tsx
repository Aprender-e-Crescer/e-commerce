      ...
      <div className="h-[685px] w-[1183px]">
        ...
        <div className="flex justify-around mt-8 text-[#333333] font-semibold">
          <div className="flex flex-col items-center">
            <img
              className="h-[480px] w-[381px] rounded-lg"
              src={dining}
              alt="Dining"
            />
            <div className="p-4">
              <h2 className="text-2xl	 font-semibold font-Poppins">Dining</h2>
            </div>
          </div>
          <div className="flex flex-col items-center">
            <img
            ...
            />
            <div className="p-4">
              <h2 className="text-2xl font-semibold font-Poppins">Living</h2>
            </div>
          </div>
          <div className="flex flex-col items-center">
            <img
            ...
            />
            <div className="p-4">
              <h2 className="text-2xl font-semibold font-Poppins">Bedroom</h2>
            </div>
          </div>
        </div>
      </div>
